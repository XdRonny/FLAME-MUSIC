...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        buttons = [
            [
                InlineKeyboardButton("👮 Aᴅᴍɪɴꜱ", url="https://t.me/Ronny_support_chats"),
            ...
            [
                InlineKeyboardButton("🤖 𝗬𝗢𝗨𝗥 𝗙𝗔𝗧𝗛𝗘𝗥", url="t.me/ll_Her_Boy_ll"),
            ],
            [
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("🤖 Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", url="https://telegra.ph/file/e7b19c0d51970e8bf8ca1.mp4"),
            ],
            [
...
async def help(client: Client, message: Message):
    ...
    buttons = [
            ...
            [
                InlineKeyboardButton("🤖 ᴏᴡɴᴇʀ", url="t.me/ll_Her_Boy_ll"),
            ],
            [
                InlineKeyboardButton("🔙 Bᴀᴄᴋ", callback_data="home"),
                InlineKeyboardButton("🤷 Cʟᴏꜱᴇ", callback_data="close"),
